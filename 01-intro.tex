...
%	\item Determinar las fuentes de ingresos
	\item Verificar la viabilidad financiera asegurando que siempre se rebase el punto de equilibrio, así como el que las razones financieras indiquen un resultado favorable para así asegurar que el proyecto puede \emph{valerse por sí mismo}
...
%	\item Verificar la viabilidad financiera del proyecto
\end{itemize}
