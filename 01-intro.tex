...
%- justificacion del apartado
En la elaboración de este trabajo convergen diferentes enfoques teóricos entre los cuales destacan tres que se mencionan con la finalidad de clarificar el enfoque a partir del cual se elaboró el presente trabajo:
...
\begin{description}
	...
	Guanajuato pasó del lugar 22º al 19º nacional en divorcios entre los años 2005 y 2009\footnote{Comparar \citep{Inegi2005pGto} con \citep{Inegi2009pGto}} con el consecuente semi abandono de los niños (\citep{Morales09}).
...
% - intro
En la \emph{\nameref{ch:Introduccion}} se planteó el marco general y metodológico desde donde se elaborará el proyecto, los objetivos, alcances, limitaciones y supuestos del proyecto.

% - Administración de Negocios
El capítulo \ref{ch:AdministracionNegocios} \emph{\nameref{ch:AdministracionNegocios}} analiza las características sociodemográficas de la región donde se llevará a cabo el proyecto para determinar las condiciones del mercado.

% - Administración de Mercados
En el capítulo \ref{ch:AdministracionMercados} \emph{\nameref{ch:AdministracionMercados}} se ven aspectos relacionados con la estrategia mercadotécnica, poniendo especial énfasis en la identidad escolar.\footnote{Dicho capítulo no aporta información para la corrida financiera, su contenido tiene un propósito descriptivo exclusivamente.}

% - Administración de Operaciones
La \emph{\nameref{ch:AdministracionOperaciones}} en el capítulo \ref{ch:AdministracionOperaciones} contiene la información necesaria para la elaboración de los presupuestos de ingresos y de egresos, los cuales permiten elaborar los estados financieros proforma.

% - Administración de Finanzas
En la \emph{\nameref{cap:Admin:Finanzas}} (capítulo \ref{cap:Admin:Finanzas}) se analiza el punto de equilibrio, el flujo neto de efectivo y las características del financiamiento requerido para iniciar el proyecto.

% - Análisis Financiero
En el capítulo \ref{cap:AnalsisFinanciero} \emph{\nameref{cap:AnalsisFinanciero}} se realizan los análisis estructural (vertical) e intertemporal (horizontal) para obtener las razones financieras; las cuales son decisivas para determinar el cumplimiento de los objetivos.

% - Evaluación Financiera
Durante la \emph{\nameref{cap:Evaluacion:Financiera}} (capítulo \ref{cap:Evaluacion:Financiera}) se muestran las variables de evaluación financiera que permiten determinar si el proyecto es atractivo com negocio lucrativo para algún inversionista.

% - Conclusiones
En las \emph{\nameref{ch:Conclusiones}} se confrontan los objetivos presentados en la \nameref{ch:Introduccion} contra los resultados obtenidos a lo largo del presente trabajo y se extraen consecuencias al respecto.
